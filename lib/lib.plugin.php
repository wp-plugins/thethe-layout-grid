<?php
class PluginLayoutGrid_Abstract
{
	protected $_config;
	public $viewIndexAll;
	public $viewIndex;
	...
	public function init()
	{
		...
		add_action( 'admin_enqueue_scripts',array($this, '_admin_editor_print_styles')); 
		if (is_admin()) {
	...
	/**
	 * _admin_editor_print_styles
	 */
	public function _admin_editor_print_styles()
	{
		wp_register_script( 'thethefly-color-picker', $this->_config['meta']['wp_plugin_dir_url'].'style/admin/js/color-picker.js' );
		// Color picker
		wp_enqueue_style( 'farbtastic' );
		wp_enqueue_script( 'thethefly-color-picker' );
		wp_enqueue_script( 'farbtastic', false, array('thethefly-color-picker'));	
		$ScriptUrl = WP_PLUGIN_URL . '/thethe-layout-grid/style/admin/js/jQuery_grid_admin.js';
		wp_register_script( 'thethe-layout-grid', $ScriptUrl);
		wp_enqueue_script( 'thethe-layout-grid' );
		$interface_css = WP_PLUGIN_URL . '/thethe-layout-grid/style/admin/colorpicker.css';
		wp_register_style('thethefly-plugin-colorpicker', $interface_css);
		wp_enqueue_style( 'thethefly-plugin-colorpicker', $interface_css );
		$ScriptUrl = WP_PLUGIN_URL . '/thethe-layout-grid/style/admin/js/jquery.zclip.min.js';
		wp_register_script( 'thethe-layout-grid-zclip', $ScriptUrl);
		wp_enqueue_script( 'thethe-layout-grid-zclip' );
	} // end func _admin_editor_print_styles
...
} // end class PluginLayoutGrid_Abstract